...
public class Fragment_oneword extends Fragment {

    private String Urlpath="https://v1.hitokoto.cn/";   //接口地址
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_oneword, container,false);
        /**
         * 初始化控件
         */
        thisView=view;
...
//        Toast.makeText(getContext(), "刷新成功！", Toast.LENGTH_LONG).show();
    ...
    private void parseJSONWithJSONObject(String data) {
        try{
            ...
            String sourse=jsonObject.getString("from");
            NextNeedDo(content,sourse);
    ...
    //接着做
    private void NextNeedDo(String content, String sourse) {
//        Log.i("内容","   :"+content);
//        Log.i("来源","   :"+sourse);
        try{
