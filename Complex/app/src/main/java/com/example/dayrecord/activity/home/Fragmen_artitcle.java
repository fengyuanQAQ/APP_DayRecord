...
public class Fragmen_artitcle extends Fragment {


    private String Urlpath="http://v1.alapi.cn/api/mryw/random";   //接口地址
    private Button btn;
...
//                    Log.i("内容1","   :"+data1);
                ...
                case 2:
                    ...
                    NextNeedDo(title,author,content);
                    break;
            }
    ...
    //接着做
    private void NextNeedDo(String title, String author, String content) {
//        Log.i("标题","   :"+title);
//        Log.i("作者","   :"+author);
//        Log.i("内容","   :"+content);
        String string1=content.replaceAll("<p>","       ");
